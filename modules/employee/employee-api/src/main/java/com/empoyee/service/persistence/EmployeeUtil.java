...
package com.empoyee.service.persistence;
...
public class EmployeeUtil {
	 ...
	 */
	public static Employee create(long eid) {
	 ...
	 */
	public static Employee remove(long eid)
		throws com.empoyee.exception.NoSuchEmployeeException {
	 ...
	 * @throws NoSuchEmployeeException if a employee with the primary key could not be found
	 */
	public static Employee findByPrimaryKey(long eid)
		throws com.empoyee.exception.NoSuchEmployeeException {
	 ...
	 */
	public static Employee fetchByPrimaryKey(long eid) {
