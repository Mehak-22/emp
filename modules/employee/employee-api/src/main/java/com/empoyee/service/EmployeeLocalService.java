...
public interface EmployeeLocalService
	...
	public Employee createEmployee(long eid);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Employee deleteEmployee(long eid) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Employee getEmployee(long eid) throws PortalException;
